...
/// <summary>
/// Data Transfer Object for updating an existing MitgliedFamilie
/// </summary>
public class UpdateMitgliedFamilieDto : IValidatableObject
{
    /// <summary>
    ...
    /// </summary>
    [Required(ErrorMessage = "MitgliedFamilieStatusId ist erforderlich")]
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        if (GueltigVon.HasValue && GueltigBis.HasValue && GueltigVon > GueltigBis)
        {
            yield return new ValidationResult(
                "GueltigVon darf nicht nach GueltigBis liegen",
                new[] { nameof(GueltigVon), nameof(GueltigBis) });
        }
    }
}
